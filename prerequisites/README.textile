...
String[] elements will be of the form (and TC will ensure this):
...
TC will make sure classSchedule contains between 1 and 20 Strings,
inclusive, all of the form above.  The Strings will have between 1 and 50
characters, inclusive.  TC will check that the syntax of the Strings are
...
single spaces.  Also, TC will ensure that each class has at most one
entry in the String[]. 
